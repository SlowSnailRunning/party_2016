layui.use(['form', 'layer', 'laydate', 'upload', 'table', 'laytpl'], function () {
    ...
    var tableIns = table.render({
        ...
        cols: [[
            ...
            {field: 'radioScore', title: '每道单选题分数', width: 110, align: 'center'},
            {field: 'checkNum', title: '多选题数量', width: 110, align: 'center'},
            {field: 'checkScore', title: '每道多选题分数', width: 110, align: 'center'},
            {field: 'judgeNum', title: '判断题数量', width: 110, align: 'center'},
            {field: 'judgeScore', title: '每道判断题分数', width: 110, align: 'center'},
            {field: 'fillNum', title: '填空题数量', width: 110, align: 'center'},
            {field: 'fillScore', title: '每道填空题分数', width: 110, align: 'center'},
            {field: 'saqNum', title: '简答题数量', width: 110, align: 'center'},
            {field: 'saqScore', title: '每道简答题分数', width: 110, align: 'center'},
            {field: 'passScore', title: '及格分数', width: 86, align: 'center'},
            {field: 'openOrClose', title: '开闭卷(0:闭卷1:开卷)', width: 170, align: 'center'},
            {field: 'isMakeup', title: '是否允许补考(0:不允许1:允许)', width: 140, align: 'center'},
