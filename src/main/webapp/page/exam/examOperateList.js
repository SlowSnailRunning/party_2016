layui.use(['form', 'layer', 'laydate', 'upload', 'table', 'laytpl'], function () {
    ...
    var tableIns = table.render({
        ...
        cols: [[
            ...
            {field: 'createTime', title: '考试创建时间', width: 160, align: "center",templet : "<div>{{layui.util.toDateString(d.ordertime, 'yyyy-MM-dd HH:mm:ss')}}</div>"},
            {field: 'examStartTime', title: '考试开始时间', width: 160, align: "center",templet : "<div>{{layui.util.toDateString(d.ordertime, 'yyyy-MM-dd HH:mm:ss')}}</div>"},
            {field: 'examEndTime', title: '考试结束时间', width: 160, align: "center",templet : "<div>{{layui.util.toDateString(d.ordertime, 'yyyy-MM-dd HH:mm:ss')}}</div>"},
